...
if (! -e "/global/cfs/cdirs/m3310/tyang25/IMERG_daily/3B-DAY-L.MS.MRG.3IMERG.${prevyear}${prevmonth}${prevday}-S000000-E235959.V07B.nc4") then
    wget --load-cookies /global/homes/t/tyang25/.urs_cookies --save-cookies /global/homes/t/tyang25/.urs_cookies --keep-session-cookies --content-disposition "https://gpm1.gesdisc.eosdis.nasa.gov/data/GPM_L3/GPM_3IMERGDL.07/${prevyear}/${prevmonth}/3B-DAY-L.MS.MRG.3IMERG.${prevyear}${prevmonth}${prevday}-S000000-E235959.V07B.nc4" -P /global/cfs/cdirs/m3310/tyang25/IMERG_daily
    echo "Yesterday's File doesn't exist, downloading"
else

    echo "Yesterday's File does exist"
endif
python /global/homes/t/tyang25/Indian_Monsoon_Onset/indian_monsoon_script.py
