...
def get_forcings_clim(year):
    forcings_clim = xarray.open_dataset(
        "../data/forcings/SST-SeaIce_clim_1979_2017_no_leap.nc"
    )

    # Create a new time coordinate
    new_time = pd.date_range(
        str(year) + "-01-01T00:00:00.000000000",
        str(year) + "-12-31T00:00:00.000000000",
        freq="D",
    ...
    if new_time.shape[0] > 365:
        new_time = new_time[
            new_time.dayofyear != 60
        ]  # Exclude day 60, which corresponds to Feb 29
