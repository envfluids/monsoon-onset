...
def main():
    ...
    logging.info("Initiating S2S Sync process")
    ...
    drive_log = base / "sync" / "logs" / "drive_S2S.txt"
    ...
    for sync_date in sync_dates:
        with open(drive_log, "r") as f:
            ...
            if sync_date in dates_list:
                ...
                try:
                    drive_sync_S2S(sync_date, cluster)
        ...
        logging.info("S2S Sync process completed successfully.")
