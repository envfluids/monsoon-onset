...
AIFS_CONFIG = ModelConfig(
    ...
    precip_var="tp",
    is_ensemble=False,
    weights_file=_BLEND_DIR / "data" / "india2026" / "AIFSv2_NGCM_blend" / "data" / "coefs" / "subdistrict_0p25deg_weights.csv",
    date_offset_hours=0,
    skip_first_day=True,
    file_template="AIFS/output/india/AIFS_single_v2/tp/tp_0p25_{date}.nc",
    init_offset_hours=0,
)
